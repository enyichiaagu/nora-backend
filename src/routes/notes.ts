...
router.get('/:id', async (req, res) => {
  try {
    ...
    const prompt = `Based on the following transcripts, create concise study notes in well-structured paragraphs (maximum 400 words). Focus only on the content from the transcripts and organize key points in flowing paragraphs with clear paragraph breaks. Make sure to separate different topics or concepts into distinct paragraphs. Do not include any headers, titles, or "Study Notes:" labels - just provide the content in paragraph format:
